...
define('buymeapp/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('routes/tasks.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/tasks.js should pass ESLint\n\n2:5 - \'that\' is assigned a value but never used. (no-unused-vars)\n32:4 - Call this._super(...arguments) in init hook (ember/require-super-in-init)\n38:16 - Use import { hash } from \'rsvp\'; instead of using Ember.RSVP.hash (ember/new-module-imports)\n38:16 - \'Ember\' is not defined. (no-undef)\n46:13 - \'swal\' is not defined. (no-undef)\n59:21 - \'swal\' is not defined. (no-undef)\n74:13 - \'swal\' is not defined. (no-undef)\n85:21 - \'swal\' is not defined. (no-undef)\n111:9 - Unexpected console statement. (no-console)\n112:9 - \'Ember\' is not defined. (no-undef)\n112:9 - Use import $ from \'jquery\'; instead of using Ember.$ (ember/new-module-imports)\n116:26 - \'resp\' is defined but never used. (no-unused-vars)\n119:27 - \'error\' is defined but never used. (no-unused-vars)\n124:16 - \'moment\' is not defined. (no-undef)\n126:41 - \'status\' is defined but never used. (no-unused-vars)');
  });
