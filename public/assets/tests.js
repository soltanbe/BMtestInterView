...
define('buymeapp/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/add-task.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/add-task.js should pass ESLint\n\n5:12 - Use import { inject } from \'@ember/service\'; instead of using Ember.inject.service (ember/new-module-imports)\n5:12 - \'Ember\' is not defined. (no-undef)\n12:17 - Use import $ from \'jquery\'; instead of using Ember.$ (ember/new-module-imports)\n12:17 - \'Ember\' is not defined. (no-undef)\n25:29 - \'swal\' is not defined. (no-undef)\n32:29 - \'swal\' is not defined. (no-undef)\n41:35 - \'error\' is defined but never used. (no-unused-vars)\n45:17 - \'swal\' is not defined. (no-undef)');
  });
  ...
  QUnit.test('routes/tasks.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/tasks.js should pass ESLint\n\n2:5 - \'that\' is assigned a value but never used. (no-unused-vars)\n32:4 - Call this._super(...arguments) in init hook (ember/require-super-in-init)\n38:16 - Use import { hash } from \'rsvp\'; instead of using Ember.RSVP.hash (ember/new-module-imports)\n38:16 - \'Ember\' is not defined. (no-undef)\n46:13 - \'swal\' is not defined. (no-undef)\n60:21 - \'swal\' is not defined. (no-undef)\n75:13 - \'swal\' is not defined. (no-undef)\n87:21 - \'swal\' is not defined. (no-undef)\n113:9 - Unexpected console statement. (no-console)\n114:9 - \'Ember\' is not defined. (no-undef)\n114:9 - Use import $ from \'jquery\'; instead of using Ember.$ (ember/new-module-imports)\n118:26 - \'resp\' is defined but never used. (no-unused-vars)\n121:27 - \'error\' is defined but never used. (no-unused-vars)\n126:16 - \'moment\' is not defined. (no-undef)\n128:41 - \'status\' is defined but never used. (no-unused-vars)');
  });
...
define('buymeapp/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('buymeapp/templates/tasks.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'buymeapp/templates/tasks.hbs should pass TemplateLint.\n\nbuymeapp/templates/tasks.hbs\n  14:20  error  Incorrect indentation of htmlAttribute \'class\' beginning at L14:C20. Expected \'class\' to be at L15:C18.  attribute-indentation\n  14:44  error  Incorrect indentation of element modifier \'action\' beginning at L14:C44. Expected \'action\' to be at L16:C18.  attribute-indentation\n  14:118  error  Incorrect indentation of close bracket \'>\' for the element \'<li>\' beginning at L14:C118. Expected \'<li>\' to be at L17:C16.  attribute-indentation\n  3:4  error  Incorrect indentation for `<div>` beginning at L3:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  11:4  error  Incorrect indentation for `<div>` beginning at L11:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  33:4  error  Incorrect indentation for `{{summary-task}}` beginning at L33:C4. Expected `{{summary-task}}` to be at an indentation of 2 but was found at 4.  block-indentation\n  34:4  error  Incorrect indentation for `<div>` beginning at L34:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  4:8  error  Incorrect indentation for `<div>` beginning at L4:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  7:8  error  Incorrect indentation for `<div>` beginning at L7:C8. Expected `<div>` to be at an indentation of 6 but was found at 8.  block-indentation\n  5:12  error  Incorrect indentation for `<h3>` beginning at L5:C12. Expected `<h3>` to be at an indentation of 10 but was found at 12.  block-indentation\n  8:12  error  Incorrect indentation for `{{add-task}}` beginning at L8:C12. Expected `{{add-task}}` to be at an indentation of 10 but was found at 12.  block-indentation\n  12:8  error  Incorrect indentation for `<ul>` beginning at L12:C8. Expected `<ul>` to be at an indentation of 6 but was found at 8.  block-indentation\n  13:12  error  Incorrect indentation for `{{#each}}` beginning at L13:C12. Expected `{{#each}}` to be at an indentation of 10 but was found at 12.  block-indentation\n  14:16  error  Incorrect indentation for `<li>` beginning at L14:C16. Expected `<li>` to be at an indentation of 14 but was found at 16.  block-indentation\n  16:20  error  Incorrect indentation for `{{#if}}` beginning at L16:C20. Expected `{{#if}}` to be at an indentation of 18 but was found at 20.  block-indentation\n  23:20  error  Incorrect indentation for `<div>` beginning at L23:C20. Expected `<div>` to be at an indentation of 18 but was found at 20.  block-indentation\n  24:20  error  Incorrect indentation for `<div>` beginning at L24:C20. Expected `<div>` to be at an indentation of 18 but was found at 20.  block-indentation\n  25:19  error  Incorrect indentation for `<!-- <span >{{task.added_date}}</span>\n                    <span  class="pull-right custom-icon-edit"> <i class="fa fa-edit"></i></span>\n                    <span {{action "deleteTask" task.id}} class="pull-right custom-icon-trash"> <i class="fa fa-trash"></i></span>-->` beginning at L25:C19. Expected `<!-- <span >{{task.added_date}}</span>\n                    <span  class="pull-right custom-icon-edit"> <i class="fa fa-edit"></i></span>\n                    <span {{action "deleteTask" task.id}} class="pull-right custom-icon-trash"> <i class="fa fa-trash"></i></span>-->` to be at an indentation of 18 but was found at 19.  block-indentation\n  17:24  error  Incorrect indentation for `<div>` beginning at L17:C24. Expected `<div>` to be at an indentation of 22 but was found at 24.  block-indentation\n  18:24  error  Incorrect indentation for `<div>` beginning at L18:C24. Expected `<div>` to be at an indentation of 22 but was found at 24.  block-indentation\n  20:24  error  Incorrect indentation for `<div>` beginning at L20:C24. Expected `<div>` to be at an indentation of 22 but was found at 24.  block-indentation\n  21:24  error  Incorrect indentation for `<div>` beginning at L21:C24. Expected `<div>` to be at an indentation of 22 but was found at 24.  block-indentation\n  35:8  error  Incorrect indentation for `<h5>` beginning at L35:C8. Expected `<h5>` to be at an indentation of 6 but was found at 8.  block-indentation\n  25:19  error  HTML comment detected  no-html-comments\n  39:0  error  HTML comment detected  no-html-comments\n  64:0  error  HTML comment detected  no-html-comments\n  2:34  error  elements cannot have inline styles  no-inline-styles\n  34:21  error  elements cannot have inline styles  no-inline-styles\n  14:44  error  Interaction added to non-interactive element  no-invalid-interactive\n  24:59  error  Interaction added to non-interactive element  no-invalid-interactive\n');
  });
});
...
define('buymeapp/tests/test-helper', ['buymeapp/app', 'buymeapp/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
require('buymeapp/tests/test-helper');
